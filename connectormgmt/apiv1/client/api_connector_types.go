...
func (r ApiListConnectorTypesRequest) OrderBy(orderBy string) ApiListConnectorTypesRequest {
	r.orderBy = &orderBy
	return r
}
func (r ApiListConnectorTypesRequest) Search(search string) ApiListConnectorTypesRequest {
	r.search = &search
	return r
}
