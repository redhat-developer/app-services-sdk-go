...
func (r ApiCreateConnectorClusterRequest) ConnectorCluster(connectorCluster ConnectorCluster) ApiCreateConnectorClusterRequest {
	r.connectorCluster = &connectorCluster
	return r
}
...
func (a *ConnectorClustersApiService) CreateConnectorClusterExecute(r ApiCreateConnectorClusterRequest) (ConnectorCluster, *_nethttp.Response, error) {
	...
	if r.connectorCluster == nil {
		return localVarReturnValue, nil, reportError("connectorCluster is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.connectorCluster
...
func (r ApiUpdateConnectorClusterByIdRequest) ConnectorCluster(connectorCluster ConnectorCluster) ApiUpdateConnectorClusterByIdRequest {
	r.connectorCluster = &connectorCluster
	return r
}
...
func (a *ConnectorClustersApiService) UpdateConnectorClusterByIdExecute(r ApiUpdateConnectorClusterByIdRequest) (*_nethttp.Response, error) {
	...
	localVarFormParams := _neturl.Values{}
	if r.connectorCluster == nil {
		return nil, reportError("connectorCluster is required and must be specified")
	}
