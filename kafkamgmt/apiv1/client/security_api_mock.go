...
// 			},
// 			GetSsoProvidersFunc: func(ctx _context.Context) ApiGetSsoProvidersRequest {
// 				panic("mock out the GetSsoProviders method")
// 			},
// 			GetSsoProvidersExecuteFunc: func(r ApiGetSsoProvidersRequest) (SsoProvider, *_nethttp.Response, error) {
// 				panic("mock out the GetSsoProvidersExecute method")
// 			},
...
type SecurityApiMock struct {
	...
	// GetSsoProvidersFunc mocks the GetSsoProviders method.
	GetSsoProvidersFunc func(ctx _context.Context) ApiGetSsoProvidersRequest

	// GetSsoProvidersExecuteFunc mocks the GetSsoProvidersExecute method.
	GetSsoProvidersExecuteFunc func(r ApiGetSsoProvidersRequest) (SsoProvider, *_nethttp.Response, error)
	...
	calls struct {
		...
		// GetSsoProviders holds details about calls to the GetSsoProviders method.
		GetSsoProviders []struct {
			// Ctx is the ctx argument value.
			Ctx _context.Context
		}
		// GetSsoProvidersExecute holds details about calls to the GetSsoProvidersExecute method.
		GetSsoProvidersExecute []struct {
			// R is the r argument value.
			R ApiGetSsoProvidersRequest
		}
	...
	lockGetSsoProviders                 sync.RWMutex
	lockGetSsoProvidersExecute          sync.RWMutex
...
// GetSsoProviders calls GetSsoProvidersFunc.
func (mock *SecurityApiMock) GetSsoProviders(ctx _context.Context) ApiGetSsoProvidersRequest {
	if mock.GetSsoProvidersFunc == nil {
		panic("SecurityApiMock.GetSsoProvidersFunc: method is nil but SecurityApi.GetSsoProviders was just called")
	}
	callInfo := struct {
		Ctx _context.Context
	}{
	...
	mock.lockGetSsoProviders.Lock()
	mock.calls.GetSsoProviders = append(mock.calls.GetSsoProviders, callInfo)
	mock.lockGetSsoProviders.Unlock()
	return mock.GetSsoProvidersFunc(ctx)
}

// GetSsoProvidersCalls gets all the calls that were made to GetSsoProviders.
// Check the length with:
//     len(mockedSecurityApi.GetSsoProvidersCalls())
func (mock *SecurityApiMock) GetSsoProvidersCalls() []struct {
	Ctx _context.Context
} {
	var calls []struct {
		Ctx _context.Context
	}
	mock.lockGetSsoProviders.RLock()
	calls = mock.calls.GetSsoProviders
	mock.lockGetSsoProviders.RUnlock()
	return calls
}

// GetSsoProvidersExecute calls GetSsoProvidersExecuteFunc.
func (mock *SecurityApiMock) GetSsoProvidersExecute(r ApiGetSsoProvidersRequest) (SsoProvider, *_nethttp.Response, error) {
	if mock.GetSsoProvidersExecuteFunc == nil {
		panic("SecurityApiMock.GetSsoProvidersExecuteFunc: method is nil but SecurityApi.GetSsoProvidersExecute was just called")
	}
	callInfo := struct {
		R ApiGetSsoProvidersRequest
	}{
	...
	mock.lockGetSsoProvidersExecute.Lock()
	mock.calls.GetSsoProvidersExecute = append(mock.calls.GetSsoProvidersExecute, callInfo)
	mock.lockGetSsoProvidersExecute.Unlock()
	return mock.GetSsoProvidersExecuteFunc(r)
}

// GetSsoProvidersExecuteCalls gets all the calls that were made to GetSsoProvidersExecute.
// Check the length with:
//     len(mockedSecurityApi.GetSsoProvidersExecuteCalls())
func (mock *SecurityApiMock) GetSsoProvidersExecuteCalls() []struct {
	R ApiGetSsoProvidersRequest
} {
	var calls []struct {
		R ApiGetSsoProvidersRequest
	}
	mock.lockGetSsoProvidersExecute.RLock()
	calls = mock.calls.GetSsoProvidersExecute
	mock.lockGetSsoProvidersExecute.RUnlock()
	return calls
}
