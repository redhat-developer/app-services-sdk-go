...
type DefaultApi interface {
	...
	/*
	 * GetCloudProviderRegions Retrieves the list of supported regions of the supported cloud provider.
	 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	 * @param id The id of record
	...
	/*
	 * GetCloudProviders Retrieves the list of supported cloud providers.
	 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	...
	/*
	 * GetServiceStatus Retrieves the status of resources e.g whether we have reached maximum service capacity
	 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	...
	/*
	 * GetVersionMetadata Retrieves the version metadata
	 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
