...
type DefaultApi interface {
	 ...
	 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	 * @param cloudId ID of the supported cloud provider
	 * @param cloudRegion Name of the supported cloud provider region
	 * @return ApiGetInstanceTypesByCloudProviderAndRegionRequest
	 */
	GetInstanceTypesByCloudProviderAndRegion(ctx _context.Context, cloudId string, cloudRegion string) ApiGetInstanceTypesByCloudProviderAndRegionRequest
 ...
 * @return ApiGetInstanceTypesByCloudProviderAndRegionRequest
 */
func (a *DefaultApiService) GetInstanceTypesByCloudProviderAndRegion(ctx _context.Context, cloudId string, cloudRegion string) ApiGetInstanceTypesByCloudProviderAndRegionRequest {
	return ApiGetInstanceTypesByCloudProviderAndRegionRequest{
		ApiService: a,
		ctx: ctx,
		cloudId: cloudId,
...
func (a *DefaultApiService) GetInstanceTypesByCloudProviderAndRegionExecute(r ApiGetInstanceTypesByCloudProviderAndRegionRequest) (SupportedKafkaInstanceTypesList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/kafkas_mgmt/v1/instance_types/{cloud_id}/{cloud_region}"
	localVarPath = strings.Replace(localVarPath, "{"+"cloud_id"+"}", _neturl.PathEscape(parameterToString(r.cloudId, "")), -1)
