...
type DefaultApi interface {
	 ...
	 * @return KafkaRequest
	 */
	RegisterEnterpriseOsdClusterExecute(r ApiRegisterEnterpriseOsdClusterRequest) (KafkaRequest, *_nethttp.Response, error)
...
func (r ApiRegisterEnterpriseOsdClusterRequest) Execute() (KafkaRequest, *_nethttp.Response, error) {
 ...
 * @return ApiRegisterEnterpriseOsdClusterRequest
 */
func (a *DefaultApiService) RegisterEnterpriseOsdCluster(ctx _context.Context) ApiRegisterEnterpriseOsdClusterRequest {
	return ApiRegisterEnterpriseOsdClusterRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return KafkaRequest
 */
func (a *DefaultApiService) RegisterEnterpriseOsdClusterExecute(r ApiRegisterEnterpriseOsdClusterRequest) (KafkaRequest, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.RegisterEnterpriseOsdCluster")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
