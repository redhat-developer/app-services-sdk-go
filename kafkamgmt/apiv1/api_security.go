 ...
 * @return ApiDeleteServiceAccountRequest
 */
func (a *SecurityApiService) DeleteServiceAccount(ctx _context.Context, id string) ApiDeleteServiceAccountRequest {
	return ApiDeleteServiceAccountRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return Error
 */
func (a *SecurityApiService) DeleteServiceAccountExecute(r ApiDeleteServiceAccountRequest) (Error, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityApiService.DeleteServiceAccount")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 * @return ApiListServiceAccountsRequest
 */
func (a *SecurityApiService) ListServiceAccounts(ctx _context.Context) ApiListServiceAccountsRequest {
	return ApiListServiceAccountsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return ServiceAccountList
 */
func (a *SecurityApiService) ListServiceAccountsExecute(r ApiListServiceAccountsRequest) (ServiceAccountList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityApiService.ListServiceAccounts")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
