...
func (mock *RegistriesApiMock) DeleteRegistry(ctx _context.Context, registryId int32) ApiDeleteRegistryRequest {
...
func (mock *RegistriesApiMock) GetRegistriesExecute(r ApiGetRegistriesRequest) ([]Registry, *_nethttp.Response, error) {
...
func (mock *RegistriesApiMock) GetRegistry(ctx _context.Context, registryId int32) ApiGetRegistryRequest {
